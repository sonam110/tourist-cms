        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="event-details-left">
                    ...
                    <div class="event-schedule">
                        <h3 class="schedule-title">Activity Schedule</h3>
            ...
            <div class="col-lg-4">
                    ...
                    <div class="event-sidebar">
                        ...
                        <form action="{{ route('booking-save') }}" method="POST">
                            ...
                            <div class="payment">
                                ...
                                <h3 class="payment-title" id="totalPayment">{{$package->icon}} 4500</h3>
                            </div>
                            <div class="event-sidebar-btn text-center">
                                <button type="submit" class="pxs-primary-btn">Book Now <i class="fa-solid fa-arrow-right-long"></i></button>
                ...
                <div class="event-sidebar-tour">
                    <h3 class="tour-header">Similar Activities</h3>
                    ...
                    <div class="tour-item">
                        ...
                        <div class="tour-content">
                            ...
                            <h3 class="price">{{$sp->icon}} {{$sp->price}} <a href="{{route('activity-detail',$sp->slug)}}" class="btn btn-sm btn-info"> <i class="fa fa-eye"></i>View</a></h3>
                        </div>
                    </div>
                    @empty
                    @endforelse
