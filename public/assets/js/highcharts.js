...
$(function(e) {
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#ff685c ', '#32cafe', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#FFF263', '#6AF9C4']
		}]
	});
	/* ---hightchart4----*/
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572', '#24CBE5', '#ff685c ', '#32cafe'],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#32cafe', '#ff685c ', '#ff5c75'],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
	...
	var chart = Highcharts.chart('highchart7', {
		...
		colors: ['#ff685c ', '#32cafe', '#ecb403', '#24CBE5', '#64E572', '#FF9655', '#f1c40f', '#6AF9C4'],
		series: [{
			type: 'column',
			colorByPoint: true,
