...
document.getElementById("phones").addEventListener("click", function(evt) {
  $("body").removeClass("app sidebar-mini rtl js-focus-visible sidenav-toggled");
  $("body").addClass("app sidebar-mini rtl js-focus-visible");
  ...
  if(evt.target.value == 5){
    ...
    width = 768;
    height = 1024; 
    $("body").addClass("app sidebar-mini rtl js-focus-visible sidenav-toggled");
